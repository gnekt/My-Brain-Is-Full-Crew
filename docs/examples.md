...
**What happens:**
1. **Food Coach** reads your profile from `health-profile.md`
2. Checks your food preferences and foods to avoid
3. Creates a 7-day meal plan:
   - Breakfast, lunch, dinner for each day
   - Calorie estimates per meal and per day (based on YOUR calculated targets)
...
6. Says: *"Your weekly plan is ready! Average daily intake: 1,850 kcal. Grocery list has 18 items. Want me to adjust anything?"*
