...
tools: {{TOOL_READ}}, {{TOOL_GLOB}}, {{TOOL_GREP}}
model: {{MODEL_FAST}}
---
...
**1. Full-Text Search**
1. Search file contents using {{TOOL_GREP}} for keywords and phrases
2. Search filenames using {{TOOL_GLOB}} for pattern matching
